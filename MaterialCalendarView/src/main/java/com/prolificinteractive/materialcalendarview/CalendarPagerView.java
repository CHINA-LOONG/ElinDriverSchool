...
abstract class CalendarPagerView extends ViewGroup implements View.OnClickListener {
    ...
    public static  ArrayList<DecoratorResult> decoratorResults = new ArrayList<>();
    @ShowOtherDates
    ...
    public void setSelectedDates(Collection<CalendarDay> dates) {
        for (DayView dayView : dayViews) {
            ...
            if(minDate!=null){
                if(day.getDate().getTime()<minDate.getDate().getTime()){
            ...
            for (DecoratorResult result : decoratorResults) {
                ...
                while (iter.hasNext()) {
                    ...
                    if (day.getDate().getTime()==calendarDay.getDate().getTime()&&result.decorator.decorateEnable()) {
                        dayView.setTextColor(Color.LTGRAY);
                    }
                }
            }
