...
public class SubmitReasonAdapter extends BaseQuickAdapter<SubmitReasonBean.DataBean,BaseViewHolder> {
    ...
    SubmitReasonAdapter.OnCancalReaonListener listener;
    public SubmitReasonAdapter(List<SubmitReasonBean.DataBean> data) {
        super(R.layout.item_cancle_reason,data);
        states = new HashMap<>();
    }

    @Override
    public void setNewData(List<SubmitReasonBean.DataBean> data) {
    ...
    public void setOnCancleReasonListener(SubmitReasonAdapter.OnCancalReaonListener listener) {
        this.listener = listener;
    }

    @Override
    protected void convert(BaseViewHolder helper, final SubmitReasonBean.DataBean item) {
        helper.setText(R.id.item_tv_reason,item.getContent());
        ...
        llReason.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                listener.cancleReason(item.getContent());
